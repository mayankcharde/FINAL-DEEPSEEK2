// ⚠️ MUST be the very first import so env vars are available when
// route modules (like payment.js) are evaluated by the JS engine.
...
// Load environment variables (dotenv/config import above handles this,
// but keep this call for compatibility with any code using dotenv directly)
dotenv.config();
